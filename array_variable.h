...
#ifndef ARRAY_VARIABLE_10012011_H_
#define ARRAY_VARIABLE_10012011_H_
...
public:
	...
	explicit array_variable(const std::vector<variable_base::pointer> &value) : value_(value) {
	}
...
private:
	std::vector<variable_base::pointer> value_;
};
