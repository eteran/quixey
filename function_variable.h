...
#ifndef FUNCTION_VARIABLE_10012011_H_
#define FUNCTION_VARIABLE_10012011_H_

#include "function.h"
#include "variable_base.h"

class function_variable : public variable_base {
public:
	explicit function_variable(const function &value) : value_(value) {
	}
